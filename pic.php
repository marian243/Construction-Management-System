<?php  
 ...
 $query = "SELECT projects.Name, tbl_images.name, projects.Cost FROM project_progress, projects, tbl_images
WHERE ProgressPercent = 100
AND project_progress.ProjectID = projects.Project_ID
AND projects.Project_ID = tbl_images.P_ID";  
 $result = mysqli_query($connect, $query);  
 echo '<div style="font-size:1.5em;color:blue">RECENTLY COMPLETED PROJECTS: </div>';
 echo nl2br("\n");
