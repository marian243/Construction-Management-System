<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "INSERT INTO `contractorinfo`(`Contractor_ID`, `ProjectID`, `ContractorName`, `ClientID`) VALUES ($myid,$mypid,'$myname',$mycid)";
      //mysqli_query($db,$sql);
   ...
   <body bgcolor = "#FFFFFF">
      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #333333; " align = "left">
            <div style = "background-color:#333333; color:#FFFFFF; padding:3px;"><b>Register Contractor</b></div>
				
            <div style = "margin:30px">
               
               <form action = "" method = "post">
                  <label>Contractor ID  :</label><input type = "text" name = "id" class = "box"/><br /><br />
